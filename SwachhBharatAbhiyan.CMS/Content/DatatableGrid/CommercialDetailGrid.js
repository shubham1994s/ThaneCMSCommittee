$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "pagingType": "input",
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=CommercialDetail",
            "type": "POST",
            "datatype": "json"
        },
...
function DownloadQRCode(Id) {
    window.location.href = "/CommercialMaster/Export?Id=" + Id;
};

function Edit(Id) {
    //alert("Aa");
    if (Id != null) {
        var url = "/CommercialMaster/AddHouseDetails?teamId=" + Id;
...
function Delete(Id) {
    if (Id != null && Id != '') {
        ...
        if (confirm("Do you want delete selected Commercial Details")) {
            var url = "/CommercialMaster/DeleteHouse?teamId=" + Id;
            window.location.href = url;
        }
    }
};
