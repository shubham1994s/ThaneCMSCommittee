$(document).ready(function () {
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=CommitteeDetail",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "CommitteeNo", "name": "CommitteeNo", "autoWidth": false },
...
function Edit(Id) {
    ...
    if (Id != null) {
        var url = "/MainMaster/AddCommitteeDetails?teamId=" + Id;
...
function Delete(Id) {
    if (Id != null && Id != '') {
        ...
        if (confirm("Do you want delete selected Ward Number?")) {
            var url = "/MainMaster/DeleteWard?teamId=" + Id;
            window.location.href = url;
        }
    }
};
