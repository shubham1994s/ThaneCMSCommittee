...
function test(id) {
    window.location.href = "/AttendenceBeatMap/Location?daId=" + id;
};

function user_route(id) {
    window.location.href = "/AttendenceBeatMap/UserRoute?daId=" + id;
};

function house_route(id) {
    window.location.href = "/AttendenceBeatMap/HouseRoute?daId=" + id;
};
function map(a) {
