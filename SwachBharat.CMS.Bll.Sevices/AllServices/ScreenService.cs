...
namespace SwachBharat.CMS.Bll.Services
{
    public class ScreenService : AppService, IScreenService
    {
            ...
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
                {
                    ...
                    if (data != null)
                    {
                        ...
                        model.TodayDSIAttandence = data.TodayDSIAttandence;
                        model.TotalDSIAttandence = data.TotalDSIAttandence;
                        model.TotalDSIVisit = data.TotalVisit;
        ...
        public VehicleRegVM GetVehicleDetails(int teamId, int PId)
        {
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
        ...
        public CommitteeVM GetCommitteeNameDetails(int teamId, string name, int PId)
        {
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
        ...
        public HouseDetailsVM GetHouseDetails(int teamId, int PId)
        {
            try
            {
                ...
                if (Details != null)
                {
                    ...
                    house.AreaList = LoadListArea(Convert.ToInt32(house.WardNo), Convert.ToInt32(house.PrabhagId)); //ListArea();
                    house.ZoneList = ListZone(PId);
                ...
                else
                {
                    ...
                    house.ReferanceId = refer;
                    house.houseQRCode = "/Images/QRcode.png";
                    house.WardList = ListWardNo(PId);
                    house.AreaList = ListArea(PId);
                    house.ZoneList = ListZone(PId);
        ...
        public SBALUserLocationMapView GetLiquidByIdforMap(int teamId, int daId, string EmpType)
        {
            try
            {
                ...
                if (Details != null)
                {
                    ...
                    house.WardList = LoadListWardNo(Convert.ToInt32(house.PrabhagId)); //ListWardNo();
                    house.AreaList = LoadListArea(Convert.ToInt32(house.WardNo), Convert.ToInt32(house.PrabhagId)); //ListArea();
                    house.ZoneList = ListZone(Convert.ToInt32(house.PrabhagId));
                    return house;
                }
                ...
                else
                {
                    ...
                    house.ReferanceId = refer;
                    house.houseQRCode = "/Images/QRcode.png";
                    house.WardList = ListWardNo(0);
                    house.AreaList = ListArea(0);
                    house.ZoneList = ListZone(0);
                    house.houseId = id;
                    return house;
                }
        ...
        public List<SBALUserLocationMapView> GetDSIAttenRoute(int daId, int areaid, int PId)
        {
            ...
            foreach (var x in data)
            {
                if (x.type == 1)
                {
                    ...
                    var gcd = db.GarbageCollectionDetails.Where(c => (c.userId == x.userId & (c.dsiScanId != null)) & EntityFunctions.TruncateTime(c.gcDate) == EntityFunctions.TruncateTime(x.datetime)).OrderBy(c => c.gcId).ToList();//.ToList();
                    ...
                    foreach (var d in gcd)
                    {
                        ...
                        if (d.dsiScanId != null)
                        {
                            if (areaid != 0)
                            {
                                var house = db.HouseMasters.Where(c => c.ReferanceId == d.dsiScanId & c.AreaId == areaid).FirstOrDefault();
                                ...
                                else if (street != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                                        ...
                                        userMobile = userName.userMobileNumber,
                                        type = Convert.ToInt32(x.type),
                                        HouseId = street.ReferanceId,
                                        HouseAddress = (street.SSAddress == null ? "" : street.SSAddress.Replace("Unnamed Road, ", "")),
                                        HouseOwnerName = street.SSName,
                                        //OwnerMobileNo = street.houseOwnerMobile,
                                ...
                                else if (liquid != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                                        ...
                                        userMobile = userName.userMobileNumber,
                                        type = Convert.ToInt32(x.type),
                                        HouseId = liquid.ReferanceId,
                                        HouseAddress = (liquid.LWAddreLW == null ? "" : liquid.LWAddreLW.Replace("Unnamed Road, ", "")),
                                        HouseOwnerName = liquid.LWName,
                                        //OwnerMobileNo = house.houseOwnerMobile,
                                        WasteType = d.gcType.ToString(),
                                        gpBeforImage = d.gpBeforImage,
                                        gpAfterImage = d.gpAfterImage,
                                ...
                                else if (commercial != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                                        ...
                                        userMobile = userName.userMobileNumber,
                                        type = Convert.ToInt32(x.type),
                                        HouseId = commercial.ReferanceId,
                                        HouseAddress = (commercial.commercialAddress == null ? "" : commercial.commercialAddress.Replace("Unnamed Road, ", "")),
                                        HouseOwnerName = commercial.commercialOwner,
                                        // OwnerMobileNo = commercial.commercialOwnerMobile,
                                        WasteType = d.garbageType.ToString(),
                            ...
                            {
                                var house = db.HouseMasters.Where(c => c.ReferanceId == d.dsiScanId).FirstOrDefault();
                ...
                if (x.type == 1)
                {
                    ...
                    foreach (var d in gcd)
                    {
                        ...
                        if (d.CTPTId != null)
                        {
                            if (areaid != 0)
                            {
                                var house = db.SauchalayAddresses.Where(c => c.Id == d.CTPTId & c.AreaId == areaid && ((ZoneId != 0 && c.ZoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.WardNo == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                            ...
                            {
                                var house = db.SauchalayAddresses.Where(c => c.Id == d.CTPTId && ((ZoneId != 0 && c.ZoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.WardNo == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                        ...
                        if (d.dyId != null)
                        {
                            if (areaid != 0)
                            {
                                var dump = db.DumpYardDetails.Where(c => c.dyId == d.dyId & c.areaId == areaid && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (dump != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                            ...
                            {
                                var dump = db.DumpYardDetails.Where(c => c.dyId == d.dyId && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (dump != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                ...
                if (x.type == 1)
                {
                    ...
                    foreach (var d in gcd)
                    {
                        ...
                        if (d.LWId != null)
                        {
                            if (areaid != 0)
                            {
                                var house = db.LiquidWasteDetails.Where(c => c.LWId == d.LWId & c.areaId == areaid && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                            ...
                            {
                                var house = db.LiquidWasteDetails.Where(c => c.LWId == d.LWId && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                ...
                if (x.type == 1)
                {
                    ...
                    foreach (var d in gcd)
                    {
                        ...
                        if (d.SSId != null)
                        {
                            if (areaid != 0)
                            {
                                var house = db.StreetSweepingDetails.Where(c => c.SSId == d.SSId & c.areaId == areaid && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                            ...
                            {
                                var house = db.StreetSweepingDetails.Where(c => c.SSId == d.SSId && ((ZoneId != 0 && c.zoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.wardId == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
        ...
        public GarbagePointDetailsVM GetGarbagePointDetails(int teamId, int PId)
        {
            try
            {
                DevSwachhBharatMainEntities dbMain = new DevSwachhBharatMainEntities();
                ...
                if (Details != null)
                {
                    ...
                    // house.WardList = ListWardNo();
                    point.AreaList = LoadListArea(Convert.ToInt32(point.WardNo), Convert.ToInt32(point.PrabhagId)); //ListArea();
                    point.ZoneList = ListZone(PId);
                    point.WardList = LoadListWardNo(Convert.ToInt32(point.PrabhagId)); //ListWardNo();
                ...
                else
                {
                    ...
                    point.WardList = ListWardNo(PId);
                    point.AreaList = ListArea(PId);
                    point.ZoneList = ListZone(PId);
                    return point;
                }
        ...
        public GarbagePointDetailsVM SaveGarbagePointDetails(GarbagePointDetailsVM data, int PId)
        {
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
                ...
                GarbagePointDetailsVM vv = GetGarbagePointDetails(gpid, PId);
                return vv;
            }
            catch (Exception)
            {
        ...
        //    return lstLanguage;
        //}
        public List<SelectListItem> ListArea(int PId)
        {
            if (PId > 0)
            {
                ...
                try
                {
                    Area = db.TeritoryMasters.Where(x => x.PrabhagId == PId).ToList()
                        .Select(x => new SelectListItem
                        {
                            Text = x.Area,
                            Value = x.Id.ToString()
        ...
        public List<SelectListItem> ListWardNo(int PId)
        {
            if (PId > 0)
            {
                ...
                try
                {
                    ...
                    WardNo = db.WardNumbers.Where(x => x.PrabhagId == PId).ToList()
                        .Select(x => new SelectListItem
                        {
        ...
        public List<SelectListItem> ListZone(int PId)
        {
            ...
            try
            {
                ...
                Zone = db.ZoneMasters.Where(z => (PId != 0 && z.zoneId == db.CommitteeMasters.Where(a => a.Id == PId).Select(b => b.zoneId).FirstOrDefault()) || PId == 0).ToList()
                   .Select(x => new SelectListItem
                   {
                       Text = x.name,
                       Value = x.zoneId.ToString()
        ...
        public List<SelectListItem> LoadListWardNo(Int32 PrabhagId)
        {
            ...
            else
            {
                try
                {
                    SelectListItem itemAdd = new SelectListItem() { Text = "Select Ward No/Name", Value = "0" };
        ...
        public List<SelectListItem> LoadListArea(Int32 WardNo, Int32 PId)
        {
            var Area = new List<SelectListItem>();
            if (WardNo == 0)
            {
            ...
            else if (WardNo > 0 && PId > 0)
            {
                try
                {
                    SelectListItem itemAdd = new SelectListItem() { Text = "Select Area", Value = "0" };
                    Area = db.TeritoryMasters.Where(c => c.wardId == WardNo && c.PrabhagId == PId).ToList()
                        .Select(x => new SelectListItem
                        {
                            Text = x.Area,
                            Value = x.Id.ToString()
        ...
        public DumpYardDetailsVM GetDumpYardtDetails(int teamId)
        {
            try
            {
                ...
                if (Details != null)
                {
                    ...
                    // house.WardList = ListWardNo();
                    dumpYard.AreaList = LoadListArea(Convert.ToInt32(dumpYard.WardNo), Convert.ToInt32(dumpYard.PrabhagId));//ListArea();
                    dumpYard.ZoneList = ListZone(Convert.ToInt32(dumpYard.PrabhagId));
                    dumpYard.WardList = LoadListWardNo(Convert.ToInt32(dumpYard.PrabhagId));//ListWardNo();
                ...
                else
                {
                    ...
                    dumpYard.WardList = ListWardNo(0);
                    dumpYard.AreaList = ListArea(0);
                    dumpYard.ZoneList = ListZone(0);
                    return dumpYard;
                }
        ...
        public StreetSweepVM GetStreetSweepDetails(int teamId, int PId)
        {
            try
            {
                DevSwachhBharatMainEntities dbMain = new DevSwachhBharatMainEntities();
                ...
                if (Details != null)
                {
                    ...
                    // house.WardList = ListWardNo();
                    StreetSweep.AreaList = LoadListArea(Convert.ToInt32(StreetSweep.WardNo), Convert.ToInt32(StreetSweep.PrabhagId));//ListArea();
                    StreetSweep.ZoneList = ListZone(PId);
                    StreetSweep.WardList = LoadListWardNo(Convert.ToInt32(StreetSweep.PrabhagId));//ListWardNo();
        ...
        public LiquidWasteVM GetLiquidWasteDetails(int teamId, int PId)
        {
            try
            {
                DevSwachhBharatMainEntities dbMain = new DevSwachhBharatMainEntities();
                ...
                if (Details != null)
                {
                    ...
                    // house.WardList = ListWardNo();
                    LiquidWaste.AreaList = LoadListArea(Convert.ToInt32(LiquidWaste.WardNo), Convert.ToInt32(LiquidWaste.PrabhagId));//ListArea();
                    LiquidWaste.ZoneList = ListZone(PId);
                    LiquidWaste.WardList = LoadListWardNo(Convert.ToInt32(LiquidWaste.PrabhagId));//ListWardNo();
        ...
        public StreetSweepVM SaveStreetSweepDetails(StreetSweepVM data, int PId)
        {
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
        ...
        public LiquidWasteVM SaveLiquidWasteDetails(LiquidWasteVM data, int PId)
        {
            try
            {
                using (var db = new DevChildSwachhBharatNagpurEntities(AppID))
                ...
                LiquidWasteVM vv = GetLiquidWasteDetails(LWId, PId);
                return vv;
            }
            catch (Exception)
            {
        ...
        public SauchalayDetailsVM GetSauchalayDetails(int teamId, int PId)
        {
            try
            {
                ...
                if (Details != null)
                {
                    ...
                    data.AreaList = LoadListArea(Convert.ToInt32(data.WardNo), Convert.ToInt32(data.PrabhagId)); //ListArea();
                    data.ZoneList = ListZone(PId);
                    return data;
                }
                else if (teamId == -2)
                {
                ...
                else
                {
                    ...
                    if (id == null)
                    {
                        ...
                        data.WardList = ListWardNo(PId);
                        data.AreaList = ListArea(PId);
                        data.ZoneList = ListZone(PId);
                    }
                    else
                    {
        ...
        public List<SBALUserLocationMapView> GetHouseTimeWiseRoute(string adate = "", DateTime? fTime = null, DateTime? tTime = null, int? userId = null, int? PId = null)
        {
            DateTime dateTime = new DateTime();
            var dateAndTime = DateTime.Now;
            var date = dateAndTime.Date;
            ...
            foreach (var x in data)
            {
                ...
                userLocation.Add(new SBALUserLocationMapView()
                {
                    ...
                    gpBeforImage = d.gpBeforImage,
                    gpAfterImage = d.gpAfterImage,
                    ZoneList = ListZone(Convert.ToInt32(PId)),
        ...
        public List<SelectListItem> AreaLstPId(int PId)
        {
            ...
            try
            {
                Area = db.TeritoryMasters.Where(a => db.WardNumbers.Where(b => (PId != 0 && b.PrabhagId == PId) || PId == 0).Select(c => c.Id).ToList().Contains(a.wardId ?? 0)).ToList()
                    .Select(x => new SelectListItem
                    {
                        Text = x.Area,
                        Value = x.Id.ToString()
        ...
        public List<SelectListItem> ListUserBeatMap(string Emptype, int PId)
        {
            ...
            try
            {
                user = db.UserMasters.Where(c => c.isActive == true && c.EmployeeType == Emptype && ((PId != 0 && c.PrabhagId == PId) || PId == 0)).Where(c => !db.EmpBeatMaps.Any(d => d.userId == c.userId))
                    .Select(x => new SelectListItem
                    {
                        Text = x.userName,
                        Value = x.userId.ToString()
                ...
                if (x.type == 1)
                {
                    ...
                    foreach (var d in gcd)
                    {
                        ...
                        if (d.houseId != null)
                        {
                            if (areaid != 0)
                            {
                                var house = db.HouseMasters.Where(c => c.houseId == d.houseId & c.AreaId == areaid && ((ZoneId != 0 && c.ZoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.WardNo == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
                            ...
                            else
                            {
                                ...
                                var house = db.HouseMasters.Where(c => c.houseId == d.houseId && ((ZoneId != 0 && c.ZoneId == ZoneId) || ZoneId == 0) && ((WardNo != 0 && c.WardNo == WardNo) || WardNo == 0) && ((PId == 0 && ((PrabhagNo != 0 && c.PrabhagId == PrabhagNo) || PrabhagNo == 0)) || c.PrabhagId == PId)).FirstOrDefault();
                                if (house != null)
                                {
                                    userLocation.Add(new SBALUserLocationMapView()
                                    {
